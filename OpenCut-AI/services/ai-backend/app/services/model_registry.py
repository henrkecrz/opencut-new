...
OLLAMA_MODEL_TIERS: list[ModelTier] = [
    ModelTier(
        ...
        models=[
            ...
            ModelSpec(
                name="Kimi K2 (Q3)",
                ollama_tag="kimi-k2:latest",
                memory_mb=1400,
                quality="great",
                description="MoonshotAI Kimi K2 — fast reasoning, strong instruction following at 3-bit",
                quantization="q3_K_M",
                kv_cache_mb_per_1k=4.0,
            ),
            ModelSpec(
    ...
    ModelTier(
        ...
        models=[
            ...
            ModelSpec(
                name="Kimi K2 (Q4)",
                ollama_tag="kimi-k2:q4_K_M",
                memory_mb=3000,
                quality="great",
                description="MoonshotAI Kimi K2 — long-context reasoning and agentic tasks at 4-bit",
                quantization="q4_K_M",
    ...
    ModelTier(
        ...
        models=[
            ...
            ModelSpec(
                name="Kimi K2 (Q5)",
                ollama_tag="kimi-k2:q5_K_M",
                memory_mb=7000,
                quality="excellent",
                description="MoonshotAI Kimi K2 near-lossless at 5-bit — best reasoning for complex video scripts",
                quantization="q5_K_M",
                kv_cache_mb_per_1k=8.0,
            ),
            ModelSpec(
...
TURBOQUANT_HF_MODELS: list[dict[str, Any]] = [
    # ── Kimi family (MoonshotAI) ─────────────────────────────────────────
    {
        ...
        "tier": "pro",
        "description": "MoonshotAI Kimi K2 — MoE architecture, 1T total / 32B active params. Frontier-class reasoning for video scripts and agentic tasks.",
    ...
    },
    {
        ...
        "context_length": 131072,
        "tier": "standard",
        "description": "Kimi Vision-Language 3B active params — multimodal, efficient for on-device inference. Handles images and text for video analysis.",
    ...
    },
    {
        ...
        "context_length": 131072,
        "tier": "standard",
        "description": "Kimi VL with enhanced chain-of-thought reasoning mode. Best for complex multi-step video editing instructions.",
        "turboquant_validated": False,
    },
    {
